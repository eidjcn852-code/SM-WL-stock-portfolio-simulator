...
assert.equal(calc.outstandingLoan(loans[0]), 50000);
assert.equal(calc.totalDebt(loans), 50000);
assert.equal(calc.grossAssets(40000, holdings), 200000);
assert.equal(calc.netAssets(40000, holdings, loans), 150000);
...
assert.equal(calc.netAssets(40000, holdings, loans, physicalAssets), 9150000);
assert.equal(calc.exposureRatio(8160000, 9150000).toFixed(2), '89.18');
...
assert.equal(calc.dailyInterest, undefined);
assert.equal(calc.estimatedMonthlyPayment, undefined);
